...
label FinalChapter:
    ...
    Tristan "{i}Why did I say that name?...{\i}"
    ...
    #--------------------------montage style--------------------------
    play music "audio/Music/EndingMontage.mp3"
    "Months pass..."
    ...
    "Sometimes he stops at the perya{p}buys kwek-kwek and isaw, and leaves half on the bench beside him... as if saving it for a missing piece."
    ...
    show bg waterbottle2
    show thoughts
    with dissolve
    "A soft, teasing voice across the board"
    show bg waterbottle3
    show thoughts
