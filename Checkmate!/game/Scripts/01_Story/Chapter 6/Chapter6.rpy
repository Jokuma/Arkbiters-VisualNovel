...
label Chapter6:
    ...
    #--------------scene 3--------------
    #--------------scene 4--------------
    image fb_6 = Movie(channel="movie_dp", play="images/Background/fb5.ogv", loop = True,size=(1920,1080))
    image fb_5 = Movie(channel="movie_dp", play="images/Background/fb6.ogv", size=(1920,1080))
    ...
    "Her smile lingers, but there's a quiet weight behind her words one Tristan doesn't notice yet."
